...
#else
  #define CASADI_PREFIX(ID) f_out_mex_ ## ID
#endif
...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  a0=arg[0]? arg[0][1] : 0;
  a1=5.7400000000000002e+00;
  a2=arg[0]? arg[0][2] : 0;
  a1=(a1*a2);
  a0=(a0+a1);
  a1=1.1640000000000001e+01;
  a3=arg[0]? arg[0][3] : 0;
  a1=(a1*a3);
  a0=(a0+a1);
  if (res[0]!=0) res[0][1]=a0;
  a0=-7.8057142857142860e+00;
  a0=(a0*a2);
  a2=-9.6842857142857142e+00;
  a2=(a2*a3);
  a0=(a0+a2);
...
CASADI_SYMBOL_EXPORT int f_out(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  return casadi_f0(arg, res, iw, w, mem);
}

CASADI_SYMBOL_EXPORT int f_out_alloc_mem(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT int f_out_init_mem(int mem) {
  return 0;
}

CASADI_SYMBOL_EXPORT void f_out_free_mem(int mem) {
}

CASADI_SYMBOL_EXPORT int f_out_checkout(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT void f_out_release(int mem) {
}

CASADI_SYMBOL_EXPORT void f_out_incref(void) {
}

CASADI_SYMBOL_EXPORT void f_out_decref(void) {
}

CASADI_SYMBOL_EXPORT casadi_int f_out_n_in(void) { return 1;}

CASADI_SYMBOL_EXPORT casadi_int f_out_n_out(void) { return 1;}

CASADI_SYMBOL_EXPORT casadi_real f_out_default_in(casadi_int i) {
  switch (i) {
    default: return 0;
  }
}

CASADI_SYMBOL_EXPORT const char* f_out_name_in(casadi_int i) {
  switch (i) {
    case 0: return "i0";
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT const char* f_out_name_out(casadi_int i) {
  switch (i) {
    case 0: return "o0";
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT const casadi_int* f_out_sparsity_in(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT const casadi_int* f_out_sparsity_out(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT int f_out_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 1;
  if (sz_res) *sz_res = 1;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 0;
...
CASADI_SYMBOL_EXPORT int f_out_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
...
#ifdef MATLAB_MEX_FILE
void mex_f_out(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  casadi_int i;
  int mem;
  casadi_real w[11];
  casadi_int *iw = 0;
  ...
  casadi_real* res[1] = {0};
  if (argc>1) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"f_out\" failed. Too many input arguments (%d, max 1)", argc);
  if (resc>1) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"f_out\" failed. Too many output arguments (%d, max 1)", resc);
  if (--argc>=0) arg[0] = casadi_from_mex(argv[0], w, casadi_s2, w+7);
  --resc;
  res[0] = w+4;
  f_out_incref();
  mem = f_out_checkout();
  i = f_out(arg, res, iw, w+7, mem);
  if (i) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"f_out\" failed.");
  f_out_release(mem);
  f_out_decref();
...
casadi_int main_f_out(casadi_int argc, char* argv[]) {
  casadi_int j;
  casadi_real* a;
  const casadi_real* r;
  casadi_int flag;
...
void mexFunction(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  if (!buf_ok) {
    mex_f_out(resc, resv, argc, argv);
    return;
  } else if (strcmp(buf, "f_out")==0) {
    mex_f_out(resc, resv, argc-1, argv+1);
    return;
  }
  mexErrMsgTxt("First input should be a command string. Possible values: 'f_out'");
}
#endif
CASADI_SYMBOL_EXPORT int main(int argc, char* argv[]) {
  if (argc<2) {
    /* name error */
  } else if (strcmp(argv[1], "f_out")==0) {
    return main_f_out(argc-2, argv+2);
  }
  fprintf(stderr, "First input should be a command string. Possible values: 'f_out'\nNote: you may use function.generate_input to create a command string.\n");
  return 1;
}
#ifdef __cplusplus
} /* extern "C" */
